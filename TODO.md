...
- [x] Place rocks at the terrain point under the clicked canvas position instead of scattering them near the look-at point.
- [x] Restore complete designed landscapes from validated browser autosaves.
